...
if cluster >= 0
    if edge_trained !=[]
        if improved == true
            filenm = data_path * data_name * "/fit_cluster"*string(cluster)*"_"*string(edge_trained[1]-1)*"_"*string(edge_trained[2]-1)*"_improved.txt"
        else
            filenm = data_path * data_name * "/fit_cluster"*string(cluster)*"_"*string(edge_trained[1]-1)*"_"*string(edge_trained[2]-1)*".txt"
        end
    else
        filenm = data_path * data_name * "/fit_cluster" * string(cluster) * ".txt"
    end
else
    if edge_trained !=[]
        if improved == true
            filenm = data_path * data_name * "/fit_" * string(edge_trained[1]-1) * "_"*string(edge_trained[2]-1) * "_improved.txt"
        else
            filenm = data_path * data_name * "/fit_" * string(edge_trained[1]-1) * "_"*string(edge_trained[2]-1) * ".txt"
        end
    else
        filenm = data_path * data_name * "/fit.txt"
    end
end
